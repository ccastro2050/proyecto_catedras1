...
`api_catedras/pruebas/Programa.cs`:
...
| **Prueba de capas** | `api_catedras/pruebas/` | Que las reglas funcionen **y** que las capas estén cortadas |
...
10. En este repositorio: los criterios de `2_spec.md`, el smoke de
    `7_quickstart.md` y la prueba de capas de `api_catedras/pruebas/` — la
