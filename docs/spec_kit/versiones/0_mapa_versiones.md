...
| **v4** | v4_aplicativo/ | El **registro de asistencia** completo (clave de acceso, enlace, QR), las **consultas multitabla**, el **dashboard**, la imagen corporativa y la **publicación** | [6, 7](../../../HISTORIAS_DE_USUARIO.md) | Las **rutinas de la base** como parte del contrato · y las reglas de negocio que **no viven en la API** |
